...
highlight規則：
- 標記 0-2 個「完整的詞語」（名詞、動詞、形容詞等）
- ✅ 正確：["蘑菇", "跳起來"] ❌ 錯誤：["豎得直直", "發光的"]
...
【highlight 標記規則】⚠️ 重要：只標記完整的詞語
- 從你創作的句子中，標記 0-2 個「完整的學習詞」
- **必須是完整的詞語單位**（名詞、動詞、形容詞等），不是短語片段
