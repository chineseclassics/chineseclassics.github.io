...
export function AdvisorsPanel() {
  ...
  // 太虛幻境：評分不再考慮治安（safety）
  const avgRating = (stats.happiness + stats.health + stats.education + stats.environment) / 4;
        ...
        <div className="space-y-4">
          <Card className="flex items-center gap-4 p-4 bg-primary/10 border-primary/30">
            ...
            <div>
              ...
              <div className="text-muted-foreground text-sm">Based on happiness, health, education & environment</div>
            </div>
          </Card>
