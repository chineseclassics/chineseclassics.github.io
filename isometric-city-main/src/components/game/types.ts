...
export type PedestrianDestType = 'school' | 'market' | 'farming' | 'park' | 'beach' | 'home';
...
// 太虛幻境：已移除 fire（消防）和 police（治安）覆蓋
export type OverlayMode = 'none' | 'power' | 'water' | 'health' | 'education' | 'subway';
