...
export const PEDESTRIAN_MAX_COUNT = 300;            // Maximum pedestrians (hard cap)
export const PEDESTRIAN_ROAD_TILE_DENSITY = 0.8;    // Target pedestrians per road tile (reduced for ancient style)
export const PEDESTRIAN_SPAWN_BATCH_SIZE = 15;      // How many to try spawning at once
export const PEDESTRIAN_SPAWN_INTERVAL = 0.5;       // Seconds between spawn batches (slower)
...
export const ZOOM_MAX = 3.0;                      // Maximum zoom level (most zoomed in)
...
// Water asset path (使用分類目錄)
export const WATER_ASSET_PATH = '/assets/nature/water.png';
export const ROAD_STONE_ASSET_PATH = '/assets/road/road_stone.png';
