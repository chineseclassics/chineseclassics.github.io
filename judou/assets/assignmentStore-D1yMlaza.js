import{B as T,u as B,r as m,P as n}from"./index-BX9PSpLQ.js";const j=T("assignment",()=>{const l=B(),c=m([]),f=m([]),g=m(new Map),i=m(!1),s=m(null);async function A(e){if(n){i.value=!0,s.value=null;try{const{data:t,error:a}=await n.from("class_assignments").select(`
          *,
          text:practice_texts (
            id,
            title,
