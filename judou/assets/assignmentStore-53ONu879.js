import{K as F,u as K,r as m,Z as n}from"./index-DT_aK3wC.js";const Z=F("assignment",()=>{const l=K(),c=m([]),f=m([]),g=m(new Map),i=m(!1),s=m(null);async function A(e){if(n){i.value=!0,s.value=null;try{const{data:t,error:a}=await n.from("class_assignments").select(`
          *,
          text:practice_texts (
            id,
            title,
