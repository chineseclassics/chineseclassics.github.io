import{y as F,u as N,r as m,N as n}from"./index-D90IEAqw.js";const j=F("assignment",()=>{const l=N(),c=m([]),f=m([]),g=m(new Map),i=m(!1),s=m(null);async function A(e){if(n){i.value=!0,s.value=null;try{const{data:t,error:a}=await n.from("class_assignments").select(`
          *,
          text:practice_texts (
            id,
            title,
