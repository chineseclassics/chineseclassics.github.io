import{v as F,u as H,r as m,H as n}from"./index-QKL4eFba.js";const j=F("assignment",()=>{const l=H(),c=m([]),f=m([]),g=m(new Map),i=m(!1),s=m(null);async function A(e){if(n){i.value=!0,s.value=null;try{const{data:t,error:a}=await n.from("class_assignments").select(`
          *,
          text:practice_texts (
            id,
            title,
