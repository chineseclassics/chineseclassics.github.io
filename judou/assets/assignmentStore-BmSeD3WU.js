import{z,u as F,r as m,O as n}from"./index-BuIPPDWO.js";const P=z("assignment",()=>{const l=F(),c=m([]),f=m([]),g=m(new Map),i=m(!1),s=m(null);async function A(e){if(n){i.value=!0,s.value=null;try{const{data:t,error:a}=await n.from("class_assignments").select(`
          *,
          text:practice_texts (
            id,
            title,
