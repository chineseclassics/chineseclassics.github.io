import{v as x,u as A,r as o,H as a}from"./index-CljGePV0.js";const S=x("assignment",()=>{const l=A(),u=o([]),d=o([]),i=o(!1),e=o(null);async function m(s){if(a){i.value=!0,e.value=null;try{const{data:t,error:n}=await a.from("class_assignments").select(`
          *,
          text:practice_texts (
            id,
            title,
