...
Instructions for AI coding assistants using OpenSpec for spec-driven development in 《紅樓舊夢》v2.

## Project Context

《紅樓舊夢》v2 是一個教育遊戲，核心目標是通過遊戲化機制促進學生閱讀《紅樓夢》前八十回。
...
- [ ] Read `docs/GAME_REDESIGN_PLAN.md` for game design context
...
- `implement-core-mvp` - 實現《紅樓舊夢》v2 的核心 MVP 版本
...
- Always refer to `docs/GAME_REDESIGN_PLAN.md` for design decisions
