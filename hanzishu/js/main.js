...
export function initializeApp() {
    ...
    // 等級系統、成就資料與積分規則皆定義於 core/config.js
    // 字詞本功能變量
    let vocabularyBook = createInitialVocabularyBook();
    ...
    // 書法經典字庫資料：參考 core/config.js 的 calligraphyData
    // 今日漢字庫 - 資料來源 core/config.js 的 meaningfulCharacters
    // 顯示今日漢字
